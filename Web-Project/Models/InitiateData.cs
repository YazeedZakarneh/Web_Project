...
namespace Web_Project.Models
{
    public static class InitiateData
    {
        ...
        public static void Initiate(MyContext context)
        {
            ...
            Student student1 = new Student { Name = "Yazeed Zakarneh", Email = "yazeed@gmail.com", Password = "0000"};
            Student student2 = new Student { Name = "Mohammed Bzour", Email = "bzour@gmail.com", Password = "0000"};
            Student student3 = new Student { Name = "Oraib Samara", Email = "oraib@gmail.com", Password = "0000"};
            Student student4 = new Student { Name = "Omar RB", Email = "omar@gmail.com", Password = "0000"};
